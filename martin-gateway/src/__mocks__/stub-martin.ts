...
export const defaultTileResponse: StubResponse = {
  ...
  headers: {
    ...
    etag: '"abc123"',
    // Deliberately public and long lived: the gateway must override this with its own private
    // Cache-Control and never forward Martin's directive for authorized tiles.
