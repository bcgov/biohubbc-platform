...
import { authenticateTileRequest, handleTileRequest, parseTilePath } from './routes/tiles.js';
...
app.get('/tiles/*', ipRateLimiter, parseTilePath, authenticateTileRequest, jtiRateLimiter, handleTileRequest);
