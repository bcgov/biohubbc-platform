 ...
 *
 * In OpenShift the gateway is served under `/tiles` on the app's own hostname, so tile requests are
...
export const corsMiddleware = (req: Request, res: Response, next: NextFunction) => {
  ...
  res.setHeader('Access-Control-Expose-Headers', 'ETag, Content-Encoding, X-Tile-Cache');
