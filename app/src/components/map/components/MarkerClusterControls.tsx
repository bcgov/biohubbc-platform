...
export const makeCountIcon = (count: number) => {
  return L.divIcon({
...
export const CountMarker: any = L.Marker.extend({
  options: {
    count: 1
  },
...
export const Marker = createLayerComponent<
  L.Marker & { setCount: (count: number) => void },
...
const MarkerClusterControls: React.FC<React.PropsWithChildren<IMarkerLayersProps>> = (props) => {
...
export default MarkerClusterControls;
