...
describe('SubmissionUploadReviewValidationPage', () => {
  ...
  it('loads the review and renders its paginated feature list', () => {
    render(
      <MemoryRouter
        initialEntries={[`/admin/submission/16/upload/${submissionUploadId}/review/validation/${reviewId}`]}>
        <Routes>
          <Route
            path="/admin/submission/:submissionId/upload/:submissionUploadId/review/validation/:reviewId"
    ...
    render(
      <MemoryRouter
        ...
        <Routes>
          ...
          />
          <Route
            path="/admin/submission/:submissionId/upload/:submissionUploadId/review/validation/:reviewId/feature/:submissionFeatureId"
