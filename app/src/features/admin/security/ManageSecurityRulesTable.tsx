...
const rows = [
  { id: 1, securityRuleName: 'Security Rule Title Security Rule Title Security Rule Title Security Rule Title', securityRuleCategory: 'Persecution and Harm', securityRuleAssignments: 33, securityRuleMatches: 39 },
