...
describe('SubmissionFeatureLayout', () => {
  ...
  it('waits for required page data even when the feature has already loaded', () => {
    const { getByTestId, queryByRole } = renderLayout(mockFeature, true);
    expect(getByTestId('feature-skeleton')).toBeVisible();
