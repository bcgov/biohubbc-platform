...
const phases = {
  ...
  test: {
    ...
    version: `${version}`,
    tag: `test-${version}`,
    host: (isStaticDeployment && staticUrlsAPI.test) || `${name}-${changeId}-a0ec71-test.apps.silver.devops.gov.bc.ca`,
    appHost: (isStaticDeployment && staticUrls.test) || `${appName}-${changeId}-a0ec71-test.apps.silver.devops.gov.bc.ca`,
    env: 'test',
    elasticsearchURL: 'https://elasticsearch-a0ec71-dev.apps.silver.devops.gov.bc.ca',
    elasticsearchEmlIndex: 'eml',
    s3KeyPrefix: 'platform',
  ...
  prod: {
    ...
    version: `${version}`,
    tag: `prod-${version}`,
    host: (isStaticDeployment && staticUrlsAPI.prod) || `${name}-${changeId}-a0ec71-prod.apps.silver.devops.gov.bc.ca`,
    appHost: (isStaticDeployment && staticUrls.prod) || `${appName}-${changeId}-a0ec71-prod.apps.silver.devops.gov.bc.ca`,
    env: 'prod',
