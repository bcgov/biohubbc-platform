...
| PostgreSQL | 17      | https://www.postgresql.org/download/ | PSQL database        |
...
If this project is running in docker you can view the api docs at: `http://localhost:6200/api/api-docs/`.
