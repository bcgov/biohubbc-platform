...
describe('paths/tickets/{ticketId}/reference', () => {
  ...
  it('POST creates a ticket reference', async () => {
    ...
    const createReferenceStub = sinon.stub(TicketService.prototype, 'createTicketReference').resolves(createdReference);

    const { mockReq, mockRes, mockNext } = getRequestHandlerMocks();
    mockReq.params = { ticketId: sourceTicketId };
    mockReq.body = { target_ticket_id: targetTicketId, relationship: 'relates_to' };
