...
describe('SubmissionFeaturePropertyIngestionService', () => {
  ...
  it('runs deterministic upload-scoped SQL phases and succeeds when no errors are recorded', async () => {
    ...
    sinon
      ...
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'dropTmpUploadPropertyValuesTable')
      .resolves();
    sinon
    ...
    sinon
      ...
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpUploadFeatureTypePropertyMapBySubmissionUploadId')
      .resolves();
    sinon
      .stub(
    ...
    sinon
      ...
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpUploadFeatureTypePropertyKeysBySubmissionUploadId')
      .resolves();
    sinon
    ...
    sinon
      ...
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpResolvedStagedPropertiesBySubmissionUploadId')
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpResolvedStagedPropertiesSubmissionFeatureIndex')
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpResolvedStagedPropertiesFeatureTypePropertyIndex')
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpResolvedStagedPropertiesPropertyTypeIndex')
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpUploadPropertyValuesTable')
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpUploadPropertyValuesPropertyTypeIndex')
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpUploadPropertyValuesFeatureTypePropertyIndex')
      .resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpUploadPropertyValuesSubmissionFeatureIndex')
      .resolves();
    const requiredStub = sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'recordMissingRequiredPropertyErrorsBySubmissionUploadId')
      .resolves();
    const primitiveStub = sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'recordPrimitiveValidationErrorsBySubmissionUploadId')
      .resolves();
    const codeErrorsStub = sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'recordCodePropertyResolutionErrorsBySubmissionUploadId')
      .resolves();
    const taxonErrorsStub = sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'recordTaxonPropertyResolutionErrorsBySubmissionUploadId')
      .resolves();
    const artifactErrorsStub = sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'recordArtifactPropertyResolutionErrorsBySubmissionUploadId')
      .resolves();

    const datetimeErrorsStub = sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'recordDatetimeNormalizationErrorsBySubmissionUploadId')
      .resolves();
    const spatialErrorsStub = sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'recordSpatialNormalizationErrorsBySubmissionUploadId')
      .resolves();
    ...
    const updateParentsStub = sinon
      .stub(SubmissionRepository.prototype, 'updateSubmissionFeatureParentsFromDataBySubmissionUploadId')
      .resolves();
  ...
  it('fails at end with grouped error details when ingestion errors exist', async () => {
    ...
    sinon.stub(ContributorService.prototype, 'getContributorBySubmissionId').resolves({ contributor_id: 77 } as any);
    sinon.stub(SubmissionFeaturePropertyIndexService.prototype, 'deletePropertyRecordsBySubmissionUploadId').resolves();
    sinon.stub(SubmissionRepository.prototype, 'deleteSubmissionFeatureRelationshipsBySubmissionUploadId').resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'deleteStagingRowsBySubmissionUploadId').resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'deleteIngestionErrorsBySubmissionUploadId').resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'stageExpandedPropertiesBySubmissionUploadId').resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createIngestionErrorTempTable').resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createIngestionErrorTempUploadIndex').resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createIngestionErrorTempErrorCodeIndex')
      .resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createIngestionErrorTempFeatureIndex').resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'dropTmpUploadPropertyValuesTable').resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'dropTmpResolvedStagedPropertiesTable').resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'dropTmpResolvedFeatureTypePropertyKeysTable')
      .resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'dropTmpUploadFeatureTypePropertyKeysTable').resolves();
    sinon.stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'dropTmpUploadFeatureTypePropertyMapTable').resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'createTmpUploadFeatureTypePropertyMapBySubmissionUploadId')
      .resolves();
    sinon
    ...
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'recordReferenceErrorsBySubmissionUploadId')
      .resolves();
    sinon.stub(SubmissionRepository.prototype, 'updateSubmissionFeatureParentsFromDataBySubmissionUploadId').resolves();
    sinon
      .stub(SubmissionFeaturePropertyIngestionRepository.prototype, 'recordUnresolvedParentErrorsBySubmissionUploadId')
      .resolves();
