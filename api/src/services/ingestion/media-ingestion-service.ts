...
export const MEDIA_INGEST_BATCH_BYTES = Number(process.env.MEDIA_INGEST_BATCH_BYTES ?? DEFAULT_MEDIA_INGEST_BATCH_BYTES);
export const MEDIA_INGEST_BATCH_FILES = Number(process.env.MEDIA_INGEST_BATCH_FILES ?? DEFAULT_MEDIA_INGEST_BATCH_FILES);
