 ...
 *
 * 1) split submission_feature_property_timestamp.value into date_value/time_value
 * 2) add submission_feature_artifact join table
 * 3) add durable submission_feature_error validation summary table
...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(`--sql
    ...
    --------------------------------------------------------------------------------
    -- 1) Split submission_feature_property_timestamp.value into date/time columns
    --------------------------------------------------------------------------------
    ...
    --------------------------------------------------------------------------------
    -- 3) Add durable upload-scoped submission_feature_error validation summary table
    --------------------------------------------------------------------------------
    ...
    --------------------------------------------------------------------------------
    -- 4) Complete cutover to explicit submission_upload lifecycle states
    ...
    --------------------------------------------------------------------------------
    -- 5) Create upload-scoped staging/work tables for deep property ingestion
    --
    -- Design notes:
    ...
    --------------------------------------------------------------------------------
    -- 5.2) Property metadata resolution staging
    ...
    --------------------------------------------------------------------------------
    -- 5.3) Typed logical-value staging
    ...
    --------------------------------------------------------------------------------
    -- 5.4) Complex-type candidate staging: datetime
    ...
    --------------------------------------------------------------------------------
    -- 5.5) Complex-type candidate staging: spatial
    ...
    --------------------------------------------------------------------------------
    -- 5.6) Complex-type candidate staging: code references
    ...
    --------------------------------------------------------------------------------
    -- 5.7) Complex-type candidate staging: taxon references
    ...
    --------------------------------------------------------------------------------
    -- 5.8) Complex-type candidate staging: artifact references
