...
insert into system_user (user_identity_source_id, user_identifier, user_guid, record_effective_date, create_date, create_user)
  values ((select user_identity_source_id from user_identity_source where name = 'SYSTEM' and record_end_date is null), 'sims-svc-4464', 'service-account-sims-svc-4464', now(), now(), 1);
