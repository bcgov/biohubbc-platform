...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(`
    ...
    insert into feature_property_type (name, description, record_effective_date) values ('string',   'A text type',                now());
    ...
    insert into feature_property_type (name, description, record_effective_date) values ('taxonomy', 'A taxonomic type',           now());
    ...
    insert into feature_property (name, display_name, description, feature_property_type_id, parent_feature_property_id, record_effective_date) values ('taxonomy',    'Taxonomy',    'The taxonomy associated to the record', (select feature_property_type_id from feature_property_type where name = 'taxonomy'), null,                                                                         now());
