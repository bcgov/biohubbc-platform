...
export async function seed(knex: Knex): Promise<void> {
  await knex.raw(`--sql
    ...
    insert into feature_property (name, display_name, description, feature_property_type_id, parent_feature_property_id, record_effective_date, calculated_value) values ('inferred_region',     'Inferred Region',      'The inferred regions of submission',       (select feature_property_type_id from feature_property_type where name = 'string'),   null,                                                                         now(), true) ON CONFLICT DO NOTHING;
