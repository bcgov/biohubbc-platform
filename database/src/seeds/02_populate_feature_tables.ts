...
export async function seed(knex: Knex): Promise<void> {
  await knex.raw(`--sql
    ...
    insert into feature_property (name, display_name, description, feature_property_type_id, parent_feature_property_id, record_effective_date) values ('inferred_region',     'inferred_region',     'The inferred regions of submission',        (select feature_property_type_id from feature_property_type where name = 'array'),    null,                                                                         now()) ON CONFLICT DO NOTHING;
