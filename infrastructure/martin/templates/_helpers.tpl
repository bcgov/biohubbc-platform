...
{{/*
Image tag (Martin Gateway). Matches the tag pushed by the deploy workflows.
*/}}
{{- define "app.imageTag" -}}
...
The Martin Gateway is exposed as a PATH on the app's own hostname (/martin), so tile requests are same
