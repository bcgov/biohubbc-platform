...
{{- else if and .Values.route.host (eq (toString .Values.app.name) "biohub-platform-api") }}
{{- printf "%s" .Values.route.host }}
{{- else }}
{{- printf "biohub-platform-api-%s-%s-%s.apps.silver.devops.gov.bc.ca" .Values.environment.changeId .Values.environment.licensePlate .Values.environment.name }}
{{- end }}
{{- end }}
...
{{- else if and .Values.route.host (eq (toString .Values.app.name) "biohub-platform-app") }}
{{- printf "%s" .Values.route.host }}
{{- else }}
{{- printf "biohub-platform-app-%s-%s-%s.apps.silver.devops.gov.bc.ca" .Values.environment.changeId .Values.environment.licensePlate .Values.environment.name }}
{{- end }}
{{- end }}